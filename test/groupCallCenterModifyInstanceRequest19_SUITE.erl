%%%-------------------------------------------------------------------
 ...
 %%% Created : 
 %%%-------------------------------------------------------------------
 -module(groupCallCenterModifyInstanceRequest19_SUITE).
 ...
 init_per_suite(Config) ->
     ...
     PubId1 = 'cctest1@lab24.timezone4.com',
     PubId2 = 'cctest2@lab24.timezone4.com',
     Phone1 = '333333',
     Phone2 = '444444',
...
nil_nil(User) ->
	...
	<command xsi:type=\"OCIReportingReportNotification\">
		...
		<request><![CDATA[<?xml version=\"1.0\" encoding=\"ISO-8859-1\"?>
			<BroadsoftDocument protocol=\"OCI\" xmlns=\"C\">
				<userId xmlns=\"\">admin</userId>
					<command xsi:type=\"GroupCallCenterModifyInstanceRequest19\" xmlns=\"\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\">
						<serviceUserId>~s</serviceUserId>
						<serviceInstanceProfile>
