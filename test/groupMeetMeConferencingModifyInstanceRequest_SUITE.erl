%%%-------------------------------------------------------------------
 ...
 %%% Created : 
 %%%-------------------------------------------------------------------
 -module(groupMeetMeConferencingModifyInstanceRequest_SUITE).
 ...
 init_per_suite(Config) ->
     ...
     PubId1 = 'metest1@lab24.timezone4.com',
     PubId2 = 'metest2@lab24.timezone4.com',
     Phone1 = '101010',
     Phone2 = '121212',
...
nil_nil(User) ->
	...
	<command xsi:type=\"OCIReportingReportNotification\">
		...
		<request><![CDATA[<?xml version=\"1.0\" encoding=\"ISO-8859-1\"?>
			<BroadsoftDocument protocol=\"OCI\" xmlns=\"C\">
				<userId xmlns=\"\">admin</userId>
					<command xsi:type=\"GroupMeetMeConferencingModifyInstanceRequest\" xmlns=\"\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\">
						<serviceUserId>~s</serviceUserId>
						<serviceInstanceProfile>
